...
export const insertMockAccountOnDatabase = async (
  accountsCollection: AccountsCollection,
  customParams?: Optional<AddAccountRepository.Params>,
): Promise<AccountModel> => {
  const opResult = await accountsCollection.insertOne({
...
export const addValidAccessToAccount = async ({
  account,
  accountsCollection,
  withAdminRole = false,
}: AddValidAccessToAccountParams): Promise<string> => {

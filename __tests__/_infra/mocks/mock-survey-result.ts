...
export const insertMockSurveyResultOnDatabase = async (surveyResultParams: SaveSurveyResultRepository.Params, surveyResultsCollection: SurveyResultsCollection): Promise<SurveyResultModel> => {

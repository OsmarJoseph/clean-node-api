...
import { mockAddAccountParams, throwError } from '@/tests/domain-tests/mocks'
...
describe('SignUp Controller', () => {
  let mockRequest = makeMockRequest()
  beforeEach(() => {
  ...
  test('Should call addAccount with correct values', async () => {
    ...
    Reflect.deleteProperty(mockRequest.body,'passwordConfirmation')
    expect(addAccountSpy.addAccountParams).toEqual(mockRequest.body)
  })
